...
cleanup() {
    ...
    if [ -d "rosbag2_autoware" ]; then
        ...
        if [ -f "rosbag2_autoware/metadata.yaml" ] && [ ! -f "rosbag2_autoware/metadata.yaml.tmp" ]; then
            ...
            python3 /aichallenge/workspace/src/aichallenge_system/script/motion_analytics_isshy_v2.py --input rosbag2_autoware --output . --save-details
            ...
            python3 /aichallenge/workspace/src/aichallenge_system/script/result-converter_isshy_v2.py 60 11 --input result-details-from-bag.json
...
# echo "Convert result"
# python3 /aichallenge/workspace/src/aichallenge_system/script/result-converter.py 60 11
# python3 /aichallenge/workspace/src/aichallenge_system/script/result-converter_isshy_v2.py 60 11 --input result-details-from-bag.json --output result-summary_isshy_v2.json
